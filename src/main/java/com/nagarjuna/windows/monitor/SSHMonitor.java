...
public class SSHMonitor implements IMonitor  {
	...
	private void connectSshSessionAndChanel(CheckPointDetails checkPointDetails) throws OCCAgentSSHException{
		 try {
			...
			result = "<RESULT><ISINCIDENT>true</ISINCIDENT><MSG>"+Base64Conversion.encode("<ROWSET><ROW><Description>"+e+"</Description></ROW></ROWSET>")+"</MSG><FORMATTEDVALUE>-1</FORMATTEDVALUE></RESULT>";
		...
		String workingDir = null;
		 try {
			...
			channelSftp = (ChannelSftp)channel;
			 ...
			 InputStream obj_InputStream = new ByteArrayInputStream(Base64Conversion.decode(checkPointDetails.getCheckPoint()).getBytes());
