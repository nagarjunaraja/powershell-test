...
public class WindowsLog implements Serializable {
	...
	public WindowsLog(String eventID, String machineName, String data,
	...
	public String toString() {
		return "WindowsLog [eventID=" + eventID
				+ ", machineName=" + machineName + ", data=" + data
				+ ", index=" + index + ", category=" + category
				+ ", categoryNumber=" + categoryNumber + ", entryType="
				+ entryType + ", message=" + message + ", source=" + source
				+ ", replacementStrings=" + replacementStrings
				+ ", instanceId=" + instanceId + ", timeGenerated="
				+ timeGenerated + ", timeWritten=" + timeWritten
				+ ", userName=" + userName + ", site=" + site + ", container="
				+ container + "]";
	}
